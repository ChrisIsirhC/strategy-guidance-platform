...
def prototype_document(folder: Path) -> str:
    ...
    .update-lines { display: grid; gap: 1px; min-width: 0; opacity: 0; white-space: nowrap; transform: translateX(6px); transition: opacity .2s ease, transform .28s cubic-bezier(.16,1,.3,1); transition-delay: .12s; }
