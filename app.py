...
def prototype_document(folder: Path) -> str:
    ...
    .update-lines { display: grid; gap: 1px; min-width: 0; opacity: 0; white-space: nowrap; transform: translateX(6px); transition: opacity .2s ease .08s, transform .28s cubic-bezier(.16,1,.3,1) .04s; }
    .update-status-row .update-toast:hover .update-lines, .update-status-row .update-toast:focus-within .update-lines { opacity: 1; transform: translateX(0); }
